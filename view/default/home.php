...
<head>
    ...
    <meta name="description" content=" <?php echo $this->config['sitename']?>是由哈鲁网络科技有限公司推出的电子支付平台，致力于提供安全、便捷、专业、简单的第四方在线支付服务" />
                    ...
                    <div class="list">
                        <div>
                            <ul>
                                ...
                                <li>提供7*24小时的客户服务</li>
                                <li>及时处理消费用户遇到的问题</li>
                                <li>客服热线电话：<?php echo $this->config['qq']?></li>
                            </ul>
                        </div>
                        <div>
                            <ul>
        ...
        <div class="section">
            <div class="page5">
                <div class="container">
                    ...
                    <div class="footer">
                        <div>
                             <?php echo $this->config['sitename']?>是由哈鲁网络科技有限公司专为商户提供收款服务支撑的平台
                        </div>
                        <div>
