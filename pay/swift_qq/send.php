...
<title>支付宝支付(<?php echo $orderid ?>)</title>
<style>
*{margin:0;padding:0;}
...
<body>
 ...
 <?php if($result):?>
 <form name="frm1" id="frm1" method="post" action="<?php echo $result?>"></form><script type="text/javascript" language="javascript">setTimeout("document.getElementById('frm1').submit();",100);</script>
