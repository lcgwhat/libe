...
class apisubmit extends api
{
   ...
   // var_dump($orderinfo);exit;
        ...
        $url .= '?orderid=' . $orderid . '&price=' . $total_fee . '&bankcode=' . $bankcode . '&remark=' . $remark.'&productName='.$productName.'&productDesc='.$productDesc.'&msg='.urlencode($data2).'&returnUrl='.$tongbuURL;
