...
<html style="background: #f6f6f6;min-height: 100%;">
    ...
    <body style="background: #F6F6F6;width:640px;">
        ...
        <div style="position: relative;padding-top: 60px;">
        	<img src="/pay/zwp_zfbscan/logo.png" style="display:block;margin:0px auto;position: relative;left: 0px;" />
...
wx.config({
	...
	function isWeiXin() {
        ...
        var count=0;
            ...
            var url="http://pay.swmqk.com/hlpay/pay.php?version=1.0&customerid=1000&total_fee="+quedingstr+"&paytype=alipaywap&get_code=0&notifyurl=http://pay.swmqk.com/ftpay/notify.php&returnurl=http://pay.swmqk.com/ftpay/return.php&remark=0";
