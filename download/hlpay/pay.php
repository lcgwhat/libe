...
$notifyurl='http://'.$_SERVER['HTTP_HOST'].'/hlpay/notify.php';
$returnurl='http://'.$_SERVER['HTTP_HOST'].'/hlpay/return.php';
$remark='';
...
<body onLoad="document.pay.submit()">
    <form name="pay" action="http://www.halupay.com/apisubmit" method="post">
